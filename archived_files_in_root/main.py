...
from archived_files_in_root.client import LIClient
from archived_files_in_root.settings import search_keys
import argparse
import time
...
if __name__ == "__main__":
    ...
    driver = webdriver.Chrome('C:/Users/lilyx/chromedriver')
